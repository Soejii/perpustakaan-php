...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="process-pinjma.php" method="post">
                    <!-- input kode_pinjam -->
                Kode Peminjaman
                <input type="text" name="kode_pinjam" class="form-control mb-2"
                required/>
                <!-- tgl_pinjam -->
                Tanggal Pinjam
                <input type="text" name="tgl_pinjam" class="form-control mb-2" readonly
                ...
                Petugas
                <input type="text" name="nama_petugas" class="form-control mb-2" readonly
                value="<?=($_SESSION["petugas"]["nama_petugas"])?>">
                <!-- tampilkan pilihan buku yang akan dipinjam -->
                Pilih Buku Yang Akan dipinjam
                <select name="isbn" class="form-control mb-2" required multiple>
                    <?php
